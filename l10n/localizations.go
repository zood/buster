...
var enStrings = map[StringAsset]interface{}{
	...
	AboutEncryptionMsg:                     "All Zood products implement end-to-end encryption, so you don't even have to trust us to not sell you out. Our first product, Zood Location, is now available and we're hoping to make more privacy preserving/enhancing services in the future.",
	...
	IfYouDontSurveilQuestionMsg:            "If you don't have advertising or use/sell user data, how do you make money?",
