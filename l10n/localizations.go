...
var enStrings = map[StringAsset]interface{}{
	...
	MobileAppsPrivacyPolicyMsg:             "Everything we build aims to increase, or at the very least preserve, your privacy. When you use Zood Location, the app tracks your location and shares it **only with your family & friends** and it is protected with **end-to-end encryption**. **Zood never has your location**, so we can't spy on you or sell your data, and nobody can compel us to reveal your location either.",
